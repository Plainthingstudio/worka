  ...
  return `
    <div id="invoice-container" style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #333; width: 100%; margin: 0 auto; padding: 0; background: white; overflow: hidden;">
      ...
      <div style="position: relative; width: 100%;">
        ...
        <!-- Invoice number in a pill/capsule style - restored white style with larger font -->
        <div style="position: absolute; right: 30px; top: 52px; padding-left: 12px; padding-right: 12px; padding-top: 5px; padding-bottom: 5px; background: white; box-shadow: 0px 1px 2px rgba(54, 61, 85, 0.08); overflow: hidden; border-radius: 25px; justify-content: center; align-items: center; gap: 10px; display: inline-flex;">
          <div style="text-align: right; color: #19213D; font-size: 16px; font-family: Inter; font-weight: 500; text-transform: uppercase; line-height: 20px; letter-spacing: 0.40px; word-wrap: break-word">${invoice.invoiceNumber}</div>
        </div>
      </div>
      ...
      <div style="padding: 30px 30px 15px 30px; margin-top: 35px; width: 100%; justify-content: space-between; align-items: flex-start; display: inline-flex; flex-wrap: wrap; align-content: flex-start">
        ...
        <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: inline-flex">
          <div style="padding-left: 12px; padding-right: 12px; padding-top: 5px; padding-bottom: 5px; background: white; box-shadow: 0px 1px 2px rgba(54, 61, 85, 0.08); overflow: hidden; border-radius: 25px; justify-content: center; align-items: center; display: inline-flex">
            <div style="text-align: right; color: #19213D; font-size: 16px; font-family: Inter; font-weight: 500; line-height: 20px; letter-spacing: 0.40px; word-wrap: break-word">From</div>
          </div>
        ...
        <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: inline-flex">
          <div style="padding-left: 12px; padding-right: 12px; padding-top: 5px; padding-bottom: 5px; background: white; box-shadow: 0px 1px 2px rgba(54, 61, 85, 0.08); overflow: hidden; border-radius: 25px; justify-content: center; align-items: center; display: inline-flex">
            <div style="text-align: right; color: #19213D; font-size: 16px; font-family: Inter; font-weight: 500; line-height: 20px; letter-spacing: 0.40px; word-wrap: break-word">Invoice to:</div>
          </div>
          <div style="align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: flex">
            <div style="width: 178px; justify-content: flex-start; align-items: flex-start; display: inline-flex">
        ...
        <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: inline-flex">
          <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: flex">
            <div style="padding-left: 12px; padding-right: 12px; padding-top: 5px; padding-bottom: 5px; background: white; box-shadow: 0px 1px 2px rgba(54, 61, 85, 0.08); overflow: hidden; border-radius: 25px; justify-content: center; align-items: center; display: inline-flex">
              <div style="text-align: right; color: #19213D; font-size: 16px; font-family: Inter; font-weight: 500; line-height: 20px; letter-spacing: 0.40px; word-wrap: break-word">Date:</div>
            </div>
            <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 4px; display: flex">
