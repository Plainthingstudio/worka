  ...
  return <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            {tasks.length > 0 && <Button variant="outline" size="sm" onClick={handleViewAllTasks} className="gap-1">
      ...
      <CardContent>
        {isLoading ? <div className="space-y-3">
            ...
            {recentTasks.map(task => <div key={task.id} className="border rounded-lg p-4 hover:shadow-sm transition-shadow">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    {task.description && <p className="text-xs text-muted-foreground mb-2 line-clamp-2">
                        {task.description}
                      </p>}
                    ...
                    <div className="flex items-center gap-4 text-xs text-muted-foreground">
                      ...
                      {task.assignees && task.assignees.length > 0 && <div className="flex items-center gap-1">
                  ...
                  <Button variant="outline" size="sm" onClick={() => handleGoToTask(task.id)} className="shrink-0">
                    Go to Task
            ...
            {tasks.length > 5 && <div className="text-center pt-2">
                <Button variant="ghost" size="sm" onClick={handleViewAllTasks} className="text-muted-foreground">
