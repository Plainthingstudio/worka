        ...
        <div className="h-[280px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            bottom: 5
              ...
              <Bar dataKey="completed" radius={[4, 4, 0, 0]} fill={CHART_COLORS.lightBlue} name="Completed" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
      <CardFooter className="flex-col items-start gap-2 text-sm pt-2 pb-4 px-6 py-[16px]">
